...
namespace Dreamteck.Splines{
    ...
    public class NodeEditor : Editor {
        ...
        void RenderConnections()
        {
            ...
            Rect viewRect = new Rect(0, 0, EditorGUIUtility.currentViewWidth - 60, connections.Length * 25);
            GUILayout.Box("Connections", GUILayout.Width(EditorGUIUtility.currentViewWidth - 30), GUILayout.Height(Mathf.Min(Mathf.Max(viewRect.height, 30), 110) + 30));
