...
namespace Dreamteck.Splines
{
    ...
    public class ParticleController : SplineUser
    {
        ...
        void HandleParticle(int index)
        {
            ...
            {
                Evaluate(evaluateResult, DMath.Lerp(clipFrom, clipTo, particleControllers[index].splinePercent));
        ...
        void OnParticleBorn(int index)
        {
            ...
            Evaluate(evaluateResult, DMath.Lerp(clipFrom, clipTo, percent));
...
#else
            particles[index].position += result.normal * startSpeed * (particles[index].startLifetime - particles[index].lifetime);
#endif
