        ...
        public override bool SceneEdit(ref SplinePoint[] points, ref List<int> selected)
        {
            ...
            if (computer.type == Spline.Type.Bezier)
            {
                ...
                for (int i = 0; i < selected.Count; i++)
                {
                    ...
                    points[selected[i]].SetTangent2Position(SplineEditorHandles.FreeMoveCircle(points[selected[i]].tangent2, HandleUtility.GetHandleSize(points[selected[i]].tangent) * 0.1f));
