...
namespace Dreamteck.Splines
{
    ...
    public static class SplineEditorGUI
    {
        ...
        public static readonly Color selectionColor = new Color(0f, 0.564f, 1f);
        public static readonly Color blackColor = new Color(0, 0, 0, 0.7f);
        public static readonly Color buttonContentColor = Color.black;
        public static readonly Color selectedButtonContentColor = new Color(1f, 1f, 1f, 0.95f);
       ...
       public static double ScreenPointToSplinePercent(SplineComputer computer, Vector2 screenPoint)
        ...
        {
            GUILayout.Box(title, GUILayout.Width(EditorGUIUtility.currentViewWidth - 45), GUILayout.Height(50));
            ...
            options[0] = "- Select -";
            int selection = EditorGUI.Popup(new Rect(10, 25, EditorGUIUtility.currentViewWidth - 65, 30), selected, options) - 1;
            GUI.EndGroup();
            return selection;
        }
