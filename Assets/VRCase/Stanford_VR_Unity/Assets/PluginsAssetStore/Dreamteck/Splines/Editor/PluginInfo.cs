...
namespace Dreamteck.Splines
{
    ...
    public class InitWindow : EditorWindow
    {
        ...
        public void init()
        {
            ...
            string path = Utils.FindFolder(Application.dataPath, "Dreamteck/Splines/Editor");
        ...
        void ChangeLog()
        {
            ...
            string text = "Version 1.0.7 includes lots of new SplineUser features, a new Spline tool and serialization of the always draw option. Because of some core changes in the SplineFollower, we are sorry to inform you that your offset and apply position/rotation settings will be lost and you will have to reconfigure all of your SplineFollowers that have custom offsets and changes.";
