...
namespace Dreamteck.Splines
{
    ...
    public partial class SplineEditor : Editor 
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                if (computer.alwaysDraw) SplineDrawer.IncludeComputerInDrawing(computer);
                else SplineDrawer.ExcludeComputerFromDrawing(computer);
            }
        ...
        void OnSceneGUI()
        {
            ...
            if (tool != PointTool.Create || createPointMode == 1 || mouseHoversToolbar)
            {
                SplineDrawer.DrawSplineComputer(computer);
                for (int i = 0; i < computers.Count; i++)
                {
                    SplineDrawer.DrawSplineComputer(computers[i], 0.0, 1.0, 0.5f);
                }
            } else
            {
            ...
            if (tool == PointTool.Create)
            {
                ...
                if (!mouseHoversToolbar) CreatePointMode();
                SceneView.RepaintAll();
            }
            ...
            if (altDown && defaultEditor.isDragging)
            {
                defaultEditor.FinishDrag();
                refreshEditors = true;
                Repaint();
        ...
        void PointMenu()
        {
            ...
            GUILayout.Box(title, GUILayout.Width(EditorGUIUtility.currentViewWidth - 25), GUILayout.Height(boxHeight));
            ...
            float yPosition = 25;
            avgPoint.position = EditorGUI.Vector3Field(new Rect(10, yPosition, EditorGUIUtility.currentViewWidth - 65, 25), "Position", avgPoint.position);
            yPosition += 22;
            if (computer.type == Spline.Type.Bezier)
            {
                avgPoint.tangent = EditorGUI.Vector3Field(new Rect(10, yPosition, EditorGUIUtility.currentViewWidth - 65, 25), "Tangent 1", avgPoint.tangent);
                yPosition += 22;
                avgPoint.tangent2 = EditorGUI.Vector3Field(new Rect(10, yPosition, EditorGUIUtility.currentViewWidth - 65, 25), "Tangent 2", avgPoint.tangent2);
                yPosition += 22;
            }
            if (computer.space == SplineComputer.Space.Local) avgPoint.position = computer.transform.TransformPoint(avgPoint.position);
            EditorGUI.LabelField(new Rect(10, yPosition, EditorGUIUtility.currentViewWidth - 65, 30), "Normal");
            if (computer.space == SplineComputer.Space.Local) avgPoint.normal = computer.transform.InverseTransformDirection(avgPoint.normal);
                ...
                avgPoint.normal.x = EditorGUI.Slider(new Rect(10 + EditorGUIUtility.currentViewWidth / 3f, yPosition, EditorGUIUtility.currentViewWidth / 1.5f - 65, 15), avgPoint.normal.x, -1f, 1f);
                yPosition += 17;
            ...
            avgPoint.normal.y = EditorGUI.Slider(new Rect(10 + EditorGUIUtility.currentViewWidth / 3f, yPosition, EditorGUIUtility.currentViewWidth / 1.5f - 65, 15), avgPoint.normal.y, -1f, 1f);
            yPosition += 17;
            ...
            avgPoint.normal.z = EditorGUI.Slider(new Rect(10 + EditorGUIUtility.currentViewWidth / 3f, yPosition, EditorGUIUtility.currentViewWidth / 1.5f - 65, 15), avgPoint.normal.z, -1f, 1f);
            yPosition += 22;
            ...
            avgPoint.size = EditorGUI.FloatField(new Rect(10, yPosition, EditorGUIUtility.currentViewWidth - 65, 15), "Size", avgPoint.size);
            yPosition += 22;
            avgPoint.color = EditorGUI.ColorField(new Rect(10, yPosition, EditorGUIUtility.currentViewWidth - 65, 15), "Color", avgPoint.color);
            yPosition += 22;
            if (computer.type == Spline.Type.Bezier) avgPoint.type = (SplinePoint.Type)EditorGUI.EnumPopup(new Rect(10, yPosition, EditorGUIUtility.currentViewWidth - 65, 15), "Point Type", avgPoint.type);
            GUI.EndGroup();
            GUILayout.Space(0);
            for (int i = 0; i < selectedPoints.Count; i++)
            {
        ...
        void GetInput()
        {
            ...
            switch (e.GetTypeForControl(controlID))
            {
                ...
                case EventType.KeyDown:
                    ...
                    if (e.keyCode == KeyCode.LeftAlt || e.keyCode == KeyCode.RightAlt) altDown = alt = true;
                    break;
