...
namespace ViRTSA
{
    ...
    public class HapticExperiment : GeomagicTouchHapticInterface
    {
        /// <summary>
        /// class instance object -singleton-
        /// </summary>
        public static HapticExperiment instance;
        ...
        protected override bool HapticsUpdateCallback()
        {
            ...
            else
            {
                ...
                //if (contactPositionX != OUTSIDE_POSITION)
                //{
                //    SimulationModule.NeedleToSkinPositionChanged(true); //USED FOR MULTITOUCH
                //}
